...
layout: book
category: book
title: "Vendredi ou la Vie sauvage - Michel Tournier"
author: Michel Tournier
date: 2026-02-13
tags: []

work_title: Vendredi ou la Vie sauvage
work_author: Michel Tournier
work_publisher: Gallimard Jeunesse
ean: 9782070650644
work_publication_date: 02/11/2012
genre: Action / Aventures
cover: /assets/images/books/vendredi-ou-la-vie-sauvage-michel-tournier/cover.jpg
rating: 4
...
glossary:
  ...
  - word: "Récif"
    definition: "Rocher ou chaîne de rochers à fleur d’eau, dans la mer"
  - word: "Mousquet"
    definition: "Arme à feu qui était en usage avant le fusil et qu’on faisait partir au moyen d’une mèche allumée"
  - word: "Étoupe"
    definition: "(Textile) Partie la plus grossière de la filasse"
  - word: "Vilebrequin"
    definition: "Outil à main, en forme de manivelle, qui soumet son embout, une mèche ou un foret, à un mouvement de rotation autour d’un axe longitudinal, pour forer un trou dans un matériau rigide"
  - word: "Pécaris"
    definition: "(Histoire naturelle) Sorte de porc sauvage de la famille des Tayassuidae, les trois espèces actuelles sont essentiellement sud-américaines"
  - word: "Hétéroclite"
    definition: "(Didactique) Qui s’écarte des règles ordinaires, composite, mélangé, divers, panaché, hétérogène. Mélangé d’éléments disparates. Se dit d’une œuvre dont les différentes parties appartiennent à des styles et des mouvements artistiques différents"
  - word: "Éperon"
    definition: "(Équitation) Pièce de métal à deux branches, qui s’adapte au talon du cavalier et dont l’extrémité pointue ou portant une molette sert à piquer les flancs du cheval pour le stimuler"
  - word: "Fanaux"
    definition: "Grosse lanterne"
  - word: "Charançon"
    definition: "(Coléoptérologie) Coléoptère qui ronge les blés et autres grains, dans les greniers"
  - word: "Belliqueux"
    definition: "Qui aime la guerre, qui cherche à la provoquer, à l’encourager. Qui manifeste un goût pour la querelle; agressif, batailleur"
  - word: "Souille"
    definition: "(Chasse) Cuvette bourbeuse où se vautre ponctuellement le gibier pour se débarrasser de ses parasites"
  - word: "Quinconce"
    definition: "Groupe de cinq arbres dont quatre sont plantés en carré et le cinquième au milieu"
  - word: "Corrals"
    definition: "Enclos où l’on parque les animaux, en particulier les bovins"
  - word: "Garenne"
    definition: "(Chasse) Défense de pêcher dans une rivière, de chasser dans un bois. Plus particulièrement, lieu à la campagne planté d'arbres, où il y a des lapins et où on a soin de les conserver"
  - word: "Vivier"
    definition: "Pièce d’eau courante ou d’eau dormante, dans laquelle on nourrit, on conserve du poisson ou des crustacés"
  - word: "Cavalcade"
    definition: "Défilé festif de gens à cheval ou de chars dans une fête publique"
  - word: "Genêt"
    definition: "Différents genres de plantes de la famille des Fabacées, qui renferment un grand nombre d’arbrisseaux et d’arbustes, la plupart à fleurs jaunes"
  - word: "Herser"
    definition: "Soumettre (la terre) à l’action de la herse"
  - word: "Repiquer"
    definition: "(Jardinage) Replanter un jeune plant venu en semis"
  - word: "Sarcler"
    definition: "(Agriculture, Jardinage) Arracher avec la main ou couper sous terre avec un instrument tranchant les mauvaises herbes qui croissent dans un champ, dans un jardin, etc."
  - word: "Bassiner"
    definition: "Chauffer un lit avec un ustensile contenant des braises : la bassinoire ou le moine"
  - word: "Litière"
    definition: "Lit de paille ou autre espèce de fourrage que l’on répand dans les écuries, dans les étables pour que les bêtes puissent s’y coucher"
  - word: "Prélat"
    definition: "(Religion) Celui qui a une dignité considérable dans l’Église, avec juridiction spirituelle ou, jadis, temporelle"
  - word: "Ankylosé"
    definition: "(Médecine) Qui souffre d’ankylose, c’est à dire d’un arrêt complet ou incomplet du mouvement dans les jointures"
  - word: "Piaffer"
    definition: "(Manège) Marcher, en levant les jambes de devant fort haut et les abaissant en frappant le sol sans presque avoir avancé, en parlant du cheval"
  - word: "Suint"
    definition: "Liquide épais et gras qui suinte du corps des bêtes à laine"
  - word: "Pantomime"
    definition: "Sorte de drame où les acteurs suppléent à la parole par le geste"
  - word: "Hauban"
    definition: "(Marine) Échelles de corde par lesquelles on monte dans la mâture"
  - word: "Hune"
    definition: "(Marine) Sorte de plate-forme élevée qui est en saillie autour des mâts et qui sert à soutenir les hommes chargés des manœuvres hautes"
  - word: "Vergue"
    definition: "Espar, généralement cylindrique, attaché en travers des mâts d’un navire pour en soutenir les voiles"
  - word: "Presbytère"
    definition: "(Religion) Habitation destinée au curé, au pasteur, dans une paroisse"
  - word: "Hirsute"
    definition: "Qui est hérissé, d’aspect sauvage"
  - word: "Robinsonnade"
    definition: "(Littérature) Genre littéraire ou narratif qui met en scène la survie et l’adaptation d’un personnage isolé, inspiré de Robinson Crusoé"
---
## Résumé
...
{% include spoiler.html description="Ce billet décrit quelques évènements majeurs du livre, même si j'estime que pour cette aventure, c'est le chemin qui importe plus que la destination." %}
...
J'adore l'idée qu'une œuvre soit tellement culte qu'elle en vienne à créer un genre à part entier avec ses codes et ses règles de base.
Chaque auteur a alors le loisir d'adapter et de déformer ces lignes directrices pour créer des œuvres tellement différentes, mais dont le fond est commun.
